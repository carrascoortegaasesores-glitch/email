...
- Texto listo para enviar.`;
  ...
  const generate=async()=>{
    ...
    try{
      const res=await fetch("/api/claude",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-5-20251001",max_tokens:1000,system:buildSystem(),messages:[{role:"user",content:buildPrompt()}]})});
